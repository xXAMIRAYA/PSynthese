  ...
  return (
    <div className="container max-w-4xl mx-auto p-4 space-y-8">
      ...
      <div className="space-y-6">
        ...
        {/* Description */}
        <div className="prose max-w-none">
          <h2 className="text-xl font-semibold mb-2">À propos de cette campagne</h2>
          <p className="whitespace-pre-line">{campaign.description}</p>
        </div>
      </div>
      
      {/* Section 3: Carte de don */}
        ...
        <CardContent className="p-6 space-y-6">
          ...
          {campaign.status === 'completed' && (
            <p className="text-center text-sm text-muted-foreground">
              Cette campagne est terminée. Merci à tous les donateurs !
            </p>
          )}
        </CardContent>
      </Card>
      ...
      <Tabs defaultValue="description" className="mt-8">
        <TabsList className="grid w-full grid-cols-3">
          ...
          <TabsTrigger value="updates">
            Mises à jour {campaign.updates?.length ? `(${campaign.updates.length})` : ''}
          </TabsTrigger>
          <TabsTrigger value="donors">Donateurs</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="description" className="mt-6">
          <div className="prose max-w-none">
            <h3 className="text-xl font-semibold">Impact de votre don</h3>
            <p>Votre don permettra de soutenir directement cette initiative cruciale. Chaque contribution compte et nous vous remercions pour votre soutien à cette cause importante.</p>
          </div>
        </TabsContent>
