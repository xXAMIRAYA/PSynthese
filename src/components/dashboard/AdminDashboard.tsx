...
import { ArrowUp, Users, Target, HeartHandshake, Heart, Award, Calendar, PlusCircle, XCircle, Edit, Trash, AlertCircle, CheckCircle } from "lucide-react";
                          ...
                          <div className="flex items-center gap-2">
                            <div className="h-8 w-8 rounded-full overflow-hidden bg-muted">
                              {donation.user?.avatar_url ? (
                                <img src={donation.user.avatar_url} alt={donation.user.name} className="h-full w-full object-cover" />
                              ) : (
